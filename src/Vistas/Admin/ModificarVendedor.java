...
public class ModificarVendedor extends javax.swing.JFrame {
    ...
    VendedorData venddata = new VendedorData(con);
  Vendedor vendedor = null;
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Seleccione el Vendedor a modificar");
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        ...
        String nombreVendedor = nombre1.getText().trim();
        String apellidoVendedor = apellidot.getText().trim();
        String correoVendedor = correo.getText().trim();
        String dniVendedor = dni.getText().trim();
        int dniConver = Integer.parseInt(dniVendedor);
        ...
        if (!esDniValido(dniVendedor)) {
            ...
            dnivali = Integer.parseInt(dniVendedor);
        }
        if (nombreVendedor.isEmpty() && apellidoVendedor.isEmpty() && correoVendedor.isEmpty() && dniVendedor.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, complete todos los campos.", "Error", JOptionPane.ERROR_MESSAGE);

        } else {
            Vendedor vendedor= (Vendedor)comboCliente.getSelectedItem();
            vendedor.setNombre(nombreVendedor);
            vendedor.setApellido(apellidoVendedor);
            vendedor.setCorreo(correoVendedor);
            vendedor.setDni(dnivali);
            venddata.modificarVendedor(vendedor);
        }
    ...
    private void comboClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboClienteActionPerformed
        ...
        vendedor = (Vendedor) comboCliente.getSelectedItem();
        nombre1.setText(vendedor.getNombre());
        apellidot.setText(vendedor.getApellido());
        correo.setText(vendedor.getCorreo());
        dni.setText(Integer.toString(vendedor.getDni()));
    ...
    private void cargarCombo() {
        ...
        vendedores = venddata.ListarVendedores();
    ...
    private javax.swing.JComboBox<Vendedor> comboCliente;
