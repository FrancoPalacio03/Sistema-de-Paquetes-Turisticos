...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2023 a las 17:20:41
...
INSERT INTO `alojamiento` (`idAlojamiento`, `nombre`, `estado`, `servicio`, `importeDiario`, `Ciudad`) VALUES
(5, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(6, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(7, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(8, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(9, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(10, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(11, 'Jonson Hotel Salta', 1, 'Habitaciones dobles', 45000, 9),
(12, 'Hotel Hyatt Salta', 1, 'Habitacion Doble', 29900, 9),
(13, 'Habitaciones Equipadas', 1, 'Baño privado', 12500, 9),
(14, 'Epic Merlo', 1, 'Pileta climatizada\nSpa\nResto', 85000, 4),
(15, 'cabaña el merlino', 1, 'Pileta\nParrilla\ncerca del rio', 28000, 10),
(16, 'Faena Hotel', 1, 'All Inclusive', 350000, 15),
(17, 'Hotel four season', 1, 'Desayuno', 580000, 15);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `alojamientovendido`
--

CREATE TABLE `alojamientovendido` (
  `idAlojamientoVendido` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `alojamientovendido`
--

INSERT INTO `alojamientovendido` (`idAlojamientoVendido`, `nombre`, `fechaIn`, `fechaOn`, `estado`, `servicio`, `importeDiario`, `Ciudad`) VALUES
(6, 'Hotel El Sol', '2023-11-29', '2023-11-21', 1, 'servicio', 7000, 4),
(7, 'Hotel Aconcagua', '2024-08-24', '2024-08-14', 1, 'servicio', 42000, 7),
(8, 'pousada del sol', '2024-05-22', '2024-05-13', 1, 'servicio', 120000, 8);
...
INSERT INTO `ciudad` (`idCiudad`, `nombre`, `pais`, `estado`, `provincia`, `url`) VALUES
(4, 'Florencio Varela', '5', 1, '1818', 'https://www.varela.gov.ar/turismo/imagenes/card-lugares.jpg'),
(5, 'La Plata', '5', 1, '1818', 'https://i.ytimg.com/vi/XxYTJVCpSzo/hqdefault.jpg'),
(6, 'Cordoba', '5', 1, '1818', 'https://turismo.cordoba.gob.ar/wp-content/uploads/2021/07/dsdsd-scaled-e1677342686741-1110x624.jpg'),
(7, 'Mendoza', '5', 1, '1830', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBYWFRgVFhYZGBgaGhocGRoYHBgaHBgaGBoaGhoaGBgcIS4lHB4rIRgYJjgmKy8xNTU1HCQ7QDs0Py40NTEBDAwMEA8QHhISHzQrJSs0NDQ0NjQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0NDQ0N'),
(8, 'Floripa', '12', 1, '1919', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBYWFRgVFhUYGRgaGBwaGhocGhwYHBoaGBgaGhkcGhwcIS4lHB4rIRgYJjgmKy8xNTU1GiQ7QDs0Py40NTEBDAwMEA8QGhISHjYrJCQ0NDQ0NDQxNDQ0NDQ0NDQ0NDQ0NDQ0NDQxNDQ0N'),
(9, 'Salta', '5', 1, '1834', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoGCBUTExcVFRUYGBcZGx8dGxkaGiEgHxwfHCEdIxwfIx8dHysjHB0qHyAcJDYlKCwuMjIyHCE3PDcxOysxMi4BCwsLDw4PHRERHTEoIykxMzQ5OTMzMTExMzExMTExMTkzMTExMTExMzMxM'),
(10, 'Merlo', '5', 1, '1836', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBUVFBcVFRUYGBcZGh4eGhoaHCEgIxoaHRkdIB0aHB0iICwkHR4pHhoeJDckKS0vMzMzHSI4PjgyPSwyMy8BCwsLDw4PHhISHjIpIikyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyM'),
(11, 'Ezeiza', '5', 1, '1818', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBUVFBgUFBUZGRgYGxsbGBoaGiAbGhsYGBobGhsdGBsbIC0lGyApIBkYJTclKS4wNDQ0GiQ5PzkxPi0yNDIBCwsLEA8QHRISHjApICkyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyMjIyM'),
(12, 'Aeroparque', '5', 1, '1818', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBUVFBgVFRUZGBgZGxsaGxsbGxwbHRodGxodGhoaGxsbIy0kGx0qIRobJTclKi4xNDQ0GiM6PzozPi0zNDEBCwsLEA8QHxISHzMqIyozMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzMzM'),
(13, 'Retiro', '5', 1, '1818', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBQVFBcVFRUXGBcaGxwbGxoaGxoaGh0dIBsbGBobGxobICwkGyApHiEbJTYlKS4wMzQzGyI5PjkyPSwyMzABCwsLEA4QHhISHjQpIikyMjI0MjI7MjUyMjIyMjIyMjIyMjI0MjIyMjIyM'),
(14, 'rosario', '5', 1, '1838', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoHCBUVFBcVFRQYGBcZGhoaGhoaGh4gIB0gHSAaHCEaIiAhISwjIh0pIB0gJTYkKS0vNDMzGiI4PjgyPSwyMy8BCwsLDw4PHRISHjQpIik0MjIyMjIyMjIyMjI0MjIyMjIyMjIyMjIyMjIyM'),
(15, 'Miami', '55', 1, '769', 'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAoGCBUVExcVFRMYGBcZGRoYGhoaGxoaGRoaGhoaHBkcGhoaHywkGhwoHxkaJDUmKCwuMjIyHSE3PDcxOysxMi4BCwsLDw4PHBERHTEoISgxMTMxMTEzMTExMTExMTExMTExMzExMTExMTExM');
...
INSERT INTO `cliente` (`idCliente`, `correo`, `nombre`, `apellido`, `dni`, `cantPersonas`, `idPaquete`) VALUES
(15, 'dsa', 'diego', 'palacio', 12345678, 3, 15),
(16, 'asdf', 'asd', 'asdf', 12345678, 5, 16),
(17, 'uno', 'uno', 'uno', 12345678, 3, 17),
(18, 'dos', 'dos', 'dos', 12345687, 1, 18);
...
(477, 64, 'PyrÃ©nÃ©es-Atlantiques'),
(478, 64, 'Hautes-PyrÃ©nÃ©es'),
(479, 64, 'PyrÃ©nÃ©es-Orientales'),
(480, 64, 'Bas Rhin'),
(481, 64, 'Haut Rhin'),
...
(545, 29, 'Emilia Romagna - ForlÃ¬-Cesena'),
...
(865, 2, 'Burgenland'),
(866, 2, 'KÃ¤rnten'),
(867, 2, 'NiederÃ¶sterreich'),
(868, 2, 'OberÃ¶sterreich'),
(869, 2, 'Salzburg'),
(870, 2, 'Steiermark'),
(871, 2, 'Tirol'),
(872, 2, 'Vorarlberg'),
...
(1619, 89, 'Tumbes'),
(1620, 89, 'Ucayali'),
(1622, 110, 'Alto ParanÃ¡'),
(1623, 110, 'Amambay'),
(1624, 110, 'BoquerÃ³n'),
(1625, 110, 'Caaguaz&uacute;'),
(1626, 110, 'CaazapÃ¡'),
(1627, 110, 'Central'),
(1628, 110, 'ConcepciÃ³n'),
(1629, 110, 'Cordillera'),
(1630, 110, 'GuairÃ¡'),
...
(1662, 81, 'RegiÃ³n de TarapacÃ¡'),
(1663, 81, 'RegiÃ³n de Antofagasta'),
(1664, 81, 'RegiÃ³n de Atacama'),
(1665, 81, 'RegiÃ³n de Coquimbo'),
(1666, 81, 'RegiÃ³n de ValparaÃ­so'),
(1667, 81, 'RegiÃ³n del Libertador General Bernardo O&#039;Higgins'),
(1668, 81, 'RegiÃ³n del Maule'),
(1669, 81, 'RegiÃ³n del BÃ­o BÃ­o'),
(1670, 81, 'RegiÃ³n de La AraucanÃ­a'),
(1671, 81, 'RegiÃ³n de Los Lagos'),
(1672, 81, 'RegiÃ³n AisÃ©n del General Carlos IbÃ¡Ã±ez del Campo'),
(1673, 81, 'RegiÃ³n de Magallanes y de la AntÃ¡rtica Chilena'),
(1674, 81, 'RegiÃ³n Metropolitana de Santiago'),
...
(1689, 185, 'QuichÃ©'),
(1690, 185, 'Retalhuleu'),
(1691, 185, 'SacatepÃ©quez'),
(1692, 185, 'San Marcos'),
(1693, 185, 'Santa Rosa'),
(1694, 185, 'SololÃ¡'),
(1695, 185, 'Suchitepequez'),
(1696, 185, 'TotonicapÃ¡n'),
(1697, 185, 'Zacapa'),
(1699, 82, 'Amazonas'),
(1700, 82, 'Antioquia'),
(1701, 82, 'Arauca'),
...
(1716, 82, 'QuindÃ­o'),
(1717, 82, 'Risaralda'),
(1718, 82, 'San AndrÃ©s y Providencia'),
(1719, 82, 'Santander'),
(1720, 82, 'Sucre'),
(1721, 82, 'Tolima'),
...
(1746, 42, 'Jalisco'),
(1747, 42, 'MÃ©xico'),
(1748, 42, 'MichoacÃ¡n de Ocampo'),
(1749, 42, 'Morelos'),
(1750, 42, 'Nayarit'),
(1751, 42, 'Nuevo LeÃ³n'),
(1752, 42, 'Oaxaca'),
(1753, 42, 'Puebla'),
(1754, 42, 'QuerÃ©taro de Arteaga'),
(1755, 42, 'Quintana Roo'),
(1756, 42, 'San Luis PotosÃ­'),
(1757, 42, 'Sinaloa'),
(1758, 42, 'Sonora'),
(1759, 42, 'Tabasco'),
(1760, 42, 'Tamaulipas'),
...
(2075, 138, 'Valverde'),
(2076, 138, 'MarÃ­a Trinidad SÃ¡nchez'),
(2077, 138, 'Azua'),
(2078, 138, 'Santiago'),
(2079, 138, 'San CristÃ³bal'),
(2080, 138, 'Peravia'),
(2081, 138, 'ElÃ­as PiÃ±a'),
(2082, 138, 'Barahona'),
(2083, 138, 'Monte Plata'),
(2084, 138, 'Salcedo'),
(2085, 138, 'La Altagracia'),
(2086, 138, 'San Juan'),
(2087, 138, 'MonseÃ±or Nouel'),
(2088, 138, 'Monte Cristi'),
(2089, 138, 'Espaillat'),
(2090, 138, 'SÃ¡nchez RamÃ­rez'),
(2091, 138, 'La Vega'),
(2092, 138, 'San Pedro de MacorÃ­s'),
...
(2099, 138, 'Pedernales'),
(2100, 138, 'SamanÃ¡'),
(2101, 138, 'Santiago RodrÃ­guez'),
(2102, 138, 'San JosÃ© de Ocoa'),
(2103, 70, 'Chiba'),
(2104, 70, 'Ehime'),
(2105, 70, 'Oita'),
(2106, 85, 'Skopje'),
...
(2196, 69, 'Jeju'),
(2201, 25, 'Delhi'),
(2202, 81, 'RegiÃ³n de Los RÃ­os'),
(2203, 81, 'RegiÃ³n de Arica y Parinacota');
...
(86, 'Malta'),
(87, 'PakistÃ¡n'),
(88, 'PapÃºa-Nueva Guinea'),
(89, 'PerÃº'),
(90, 'Filipinas'),
(91, 'Arabia Saudita'),
(92, 'Tailandia'),
(93, 'Emiratos Ã¡rabes Unidos'),
(94, 'Groenlandia'),
(95, 'Venezuela'),
(96, 'Zimbabwe'),
(97, 'Kenia'),
...
(151, 'BenÃ­n'),
(152, 'ButÃ¡n'),
(154, 'Islas Virgenes BritÃ¡nicas'),
(155, 'BrunÃ©i'),
(156, 'Burkina Faso'),
(157, 'Burundi'),
(158, 'Camboya'),
...
(220, 'Santa LucÃ­a'),
(221, 'San Pedro y MiquelÃ³n'),
(222, 'San Vincente y Granadinas'),
(223, 'Samoa'),
(224, 'San Marino'),
(225, 'San TomÃ© y PrÃ­ncipe'),
...
--
-- Estructura de tabla para la tabla `paquetevendido`
--

CREATE TABLE `paquetevendido` (
  `idPaqueteVendido` int(11) NOT NULL,
  `idCiudadOrigen` int(11) NOT NULL,
  `idCiudadDestino` int(11) NOT NULL,
  `IdAlojamiento` int(11) NOT NULL,
  `idPasaje` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `paquetevendido`
--

INSERT INTO `paquetevendido` (`idPaqueteVendido`, `idCiudadOrigen`, `idCiudadDestino`, `IdAlojamiento`, `idPasaje`, `idVendedor`) VALUES
(15, 5, 4, 6, 13, 1),
(16, 5, 4, 6, 13, 2),
(17, 6, 7, 7, 14, 2),
(18, 7, 8, 8, 15, 2);
...
INSERT INTO `pasaje` (`idPasaje`, `tipoTransporte`, `importe`, `idCiudadOrigen`, `estado`) VALUES
(8, 'AvionNacional', 100000, 5, 1),
(9, 'AvionNacional', 100000, 5, 1),
(10, 'AvionNacional', 100000, 5, 1),
(11, 'AvionNacional', 100000, 5, 1),
(12, 'AvionNacional', 100000, 6, 1),
(13, 'AvionNacional', 100000, 5, 1),
(14, 'AvionaMendoza', 150000, 6, 1),
(15, 'AutobusaFloripa', 12000, 7, 1);
...
INSERT INTO `vendedor` (`idVendedor`, `correo`, `pass`, `nombre`, `apellido`, `dni`, `cont`, `estado`) VALUES
(1, 'francopalacio03@gmail.com', '031102', 'Franco', 'Palacio', 44596658, 14, 1),
(2, 'aaaa@gg.com', '123456', 'mauro', 'benito', 25874125, 3, 1);
...
--
-- Indices de la tabla `alojamientovendido`
--
ALTER TABLE `alojamientovendido`
  ADD PRIMARY KEY (`idAlojamientoVendido`),
...
--
-- Indices de la tabla `paquetevendido`
--
ALTER TABLE `paquetevendido`
  ADD PRIMARY KEY (`idPaqueteVendido`),
  ADD KEY `idPasaje` (`idPasaje`),
  ADD KEY `idCiudadDestino` (`idCiudadDestino`),
  ADD KEY `idCiudadOrigen` (`idCiudadOrigen`),
  ADD KEY `idVendedor` (`idVendedor`),
  ADD KEY `paquetevendido_ibfk_1` (`IdAlojamiento`);
...
--
-- AUTO_INCREMENT de la tabla `alojamientovendido`
--
ALTER TABLE `alojamientovendido`
  MODIFY `idAlojamientoVendido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de la tabla `paquetevendido`
--
ALTER TABLE `paquetevendido`
  MODIFY `idPaqueteVendido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de la tabla `pasaje`
--
ALTER TABLE `pasaje`
  MODIFY `idPasaje` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
-- Filtros para la tabla `alojamientovendido`
--
ALTER TABLE `alojamientovendido`
  ADD CONSTRAINT `alojamientovendido_ibfk_1` FOREIGN KEY (`Ciudad`) REFERENCES `ciudad` (`idCiudad`);

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`idPaquete`) REFERENCES `paquetevendido` (`idPaqueteVendido`) ON UPDATE NO ACTION;
...
ALTER TABLE `paquete`
  ...
  ADD CONSTRAINT `paquete_ibfk_2` FOREIGN KEY (`IdAlojamiento`) REFERENCES `alojamientovendido` (`idAlojamientoVendido`),
...
--
-- Filtros para la tabla `paquetevendido`
--
ALTER TABLE `paquetevendido`
  ADD CONSTRAINT `paquetevendido_ibfk_1` FOREIGN KEY (`IdAlojamiento`) REFERENCES `alojamientovendido` (`idAlojamientoVendido`),
  ADD CONSTRAINT `paquetevendido_ibfk_3` FOREIGN KEY (`idPasaje`) REFERENCES `pasaje` (`idPasaje`),
  ADD CONSTRAINT `paquetevendido_ibfk_4` FOREIGN KEY (`idCiudadDestino`) REFERENCES `ciudad` (`idCiudad`),
  ADD CONSTRAINT `paquetevendido_ibfk_5` FOREIGN KEY (`idCiudadOrigen`) REFERENCES `ciudad` (`idCiudad`),
  ADD CONSTRAINT `paquetevendido_ibfk_6` FOREIGN KEY (`idVendedor`) REFERENCES `vendedor` (`idVendedor`);
